...
# Load images
UFO1 = pygame.image.load(os.path.join("assets", "ufo1.png"))
UFO2 = pygame.image.load(os.path.join("assets", "ufo2.png"))
UFO3 = pygame.image.load(os.path.join("assets", "ufo3.png"))

# Player ship
PLAYER_ID = pygame.image.load(os.path.join("assets", "spaceship.png"))
...
class Enemy(Ship):
    COLOR_MAP = {
                "red": (UFO1, RED_LASER),
                "green": (UFO2, GREEN_LASER),
                "blue": (UFO3, BLUE_LASER)
                }
...
def main():
    ...
    def redraw_window():
        ...
        score_label = main_font.render(f"Score: {player.hits}", 1, (255,255,255))
